...
export const ARTICLES = [
  ...
  { id: 'test-voice', cat: 'test', q: 'How do I test my team by voice?',
    ...
    a: `Choose Voice in the Test step and press Start. Your browser asks for the microphone. Talk naturally and interrupt any time. Test calls end automatically after a few minutes, they are free while you set up, and the transcript is saved to Squadron HQ.` },
  ...
  { id: 'free-trial', cat: 'billing', q: 'Is there a free trial?',
    ...
    a: `Building and testing your team is free. Type your website, and Squadron builds your Business Profile and your team, and you can talk to it by chat and by voice in your browser without paying anything. You choose a plan only when you go live, from $39 for 30 days, prepaid, with no contract.` },
