...
export const ARTICLES = [
  ...
  { id: 'pricing', cat: 'billing', q: 'How much does Squadron cost?',
    keys: 'price pricing cost how much plans basic pro command center tiers',
    a: `Plans are prepaid for 30 days: Basic is $39 with 250 AI voice minutes, Pro is $79 with 650 minutes, and Command Center is $199 with 2,000 minutes. Every plan includes the full team and unlimited web chat. Extra voice minutes cost 25¢ each, prepaid in blocks of 100.` },
