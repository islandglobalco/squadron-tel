...
const AGENTS = [
  ...
  { name: 'Sparrow', voice: 'sage', tone: 'Relaxed and direct; answers plainly without selling.', text: "I'm Sparrow. The common questions, like hours, prices and where things are. Quick, straight answers." },
  { name: 'Flightline', voice: 'sage', tone: 'Patient and composed; explains one step at a time.', text: "I'm Flightline. I help new customers get set up, one step at a time, at whatever pace suits them." },
  { name: 'Scramble', voice: 'onyx', tone: 'Composed and direct; sorts out the problem without drama.', text: "I'm Scramble. I work out what you need and get you to the right place, quickly." },
  { name: 'Locksmith', voice: 'ballad', tone: 'Measured and reassuring without being sugary.', text: "I'm Locksmith. Locked out, lost password, wrong email on file. We'll sort it out carefully." },
  ...
  { name: 'Rosetta', voice: 'ballad', tone: 'Soft-spoken, attentive and unhurried.', text: "I'm Rosetta. I speak with customers in their own language, clearly and without rushing." },
  ...
  { name: 'Wingman', voice: 'marin', tone: 'Relaxed and genuine; recommends only what fits and never pushes.', text: "I'm Wingman. If there's a better option for you, I'll mention it once, and I won't push." },
  ...
  { name: 'Afterburner', voice: 'onyx', tone: 'Calm and efficient; unhurried even when it is busy.', text: "I'm Afterburner. When it gets busy, I keep answers fast and accurate so nobody waits long." },
  ...
  try {
    ...
    const ttsRes = await fetch('https://api.openai.com/v1/audio/speech', {
      ...
      body: JSON.stringify({
        ...
        voice: agent.voice,
        input: agent.text,
        instructions: `Voice direction: ${agent.tone} Sound like a senior operator at an elite technology firm, someone paid very well because they are exceptionally good: calm, precise and quietly confident, with crisp diction and a measured, unhurried pace. Low-key authority, not warmth. Nothing like a typical call-center voice: no scripted friendliness, no smile in the voice, no enthusiasm, no upward inflection, no sales energy. Short, deliberate pauses between sentences. This is a brief, understated self-introduction.`,
        response_format: 'wav',
        speed: 0.95,
      }),
    });
