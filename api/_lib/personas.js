...
export const PERSONAS = [
  ...
  { idx: 4, name: 'Sparrow', alias: 'Echo', rank: 'Airman First Class', voice: 'sage', tone: 'Relaxed and direct; answers plainly without selling.', portrait: HELMET + '04.svg' },
  { idx: 5, name: 'Flightline', alias: 'Lyra', rank: 'Staff Sergeant', voice: 'sage', tone: 'Patient and composed; explains one step at a time.', portrait: HELMET + '05.svg' },
  { idx: 6, name: 'Scramble', alias: 'Rex', rank: 'Senior Airman', voice: 'onyx', tone: 'Composed and direct; sorts out the problem without drama.', portrait: HELMET + '06.svg' },
  { idx: 7, name: 'Locksmith', alias: 'Iris', rank: 'Tech Sergeant', voice: 'ballad', tone: 'Measured and reassuring without being sugary.', portrait: HELMET + '07.svg' },
  ...
  { idx: 14, name: 'Rosetta', alias: 'River', rank: 'Captain', voice: 'ballad', tone: 'Soft-spoken, attentive and unhurried.', portrait: HELMET + '14.svg' },
  ...
  { idx: 18, name: 'Afterburner', alias: 'Blaze', rank: 'Tech Sergeant', voice: 'onyx', tone: 'Calm and efficient; unhurried even when it is busy.', portrait: HELMET + '18.svg' },
